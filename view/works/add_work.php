...
<div style="max-width: 500px;margin: 150px auto 0">
  <form id="form" class="pb-3">
    ...
    <div class="mb-3">
      ...
      <input class="form-control" name="client_name" id="client_name" cols="30" rows="10" />
    </div>
    <div id="client_name_input_error"></div>

    <div class="mb-3">
      <label for="date" class="form-label">Date</label>
      <input type="date" class="form-control" name="date" id="date" cols="30" rows="10" />
    </div>
    <div id="date_input_error"></div>

    <div class="mb-3">
      <label for="location" class="form-label">Location</label>
      <input class="form-control" name="location" id="location_work" cols="30" rows="10" />
    </div>
    <div id="location_input_error"></div>

    <div class="mb-3">
      <label for="project_link" class="form-label">Project link</label>
      <input class="form-control" name="project_link" id="project_link" cols="30" rows="10" />
    </div>
    <div id="project_link_input_error"></div>

    <div class="mb-3">
      <label for="category" class="form-label">Category</label>
      <input class="form-control" name="category" id="category" cols="30" rows="10" />
    </div>
...
<script>
  ...
  form.onsubmit = function(e) {
    ...
    xhr.open('POST', 'functions/users/works/add.php');
    xhr.send(data);
    xhr.onload = function() {
